...
public class SitPatherDemo : MonoBehaviour
{
    // Start is called before the first frame update


//actually this one should just be where you click o nthe tilemap and it shows the path then can advance along it...
    ...
    void Start()
    {
        ...
        //mainGrid = FindSceneObjectsOfType(Grid); //how does one auto find the grid...? dumb
        crntIndex = 0;
